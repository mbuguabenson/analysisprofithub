...
export const BUTTON_STYLES = {
  tradeNow: "bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white px-6 py-3 text-lg font-bold shadow-[0_0_30px_rgba(34,197,94,0.6)] animate-pulse",
  primary: "bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white px-6 py-3 font-bold",
