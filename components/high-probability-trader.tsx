...
export function HighProbabilityTrader({ ticks, accountBalance, theme = "dark" }: HighProbabilityTraderProps) {
  ...
  useEffect(() => {
    ...
    const targets = MartingaleCalculator.calculateDailyTargets(
      accountBalance,
      tradingHours,
      targetPercentage
    )
    ...
    const levels = MartingaleCalculator.calculateHighProbabilityStakes(
      accountBalance,
      riskPercentage
    )
    ...
    <div className="space-y-6">
      <div className={`rounded-xl p-6 border ${
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Badge className={`${autoTrading ? "bg-green-500/20 text-green-400 border-green-500/40" : "bg-slate-500/20 text-slate-400 border-slate-500/40"}`}>
            {autoTrading ? "AUTO TRADING ON" : "Manual Mode"}
          </Badge>
        </div>

        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className={`grid w-full grid-cols-4 ${theme === "dark" ? "bg-slate-800/50" : "bg-slate-100"}`}>
          ...
          <TabsContent value="settings" className="space-y-4 mt-4">
            ...
            <div className={`p-4 rounded-lg border flex items-center justify-between ${
              ...
              <div>
                <p className={`font-semibold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>Use Martingale</p>
            ...
            <div className={`p-4 rounded-lg border flex items-center justify-between ${
              ...
              <div>
                <p className={`font-semibold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>Enable Auto Trading</p>
                <p className={`text-sm ${theme === "dark" ? "text-slate-400" : "text-slate-600"}`}>
          ...
          <TabsContent value="targets" className="space-y-4 mt-4">
            {dailyTargets && (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className={`p-4 rounded-lg border text-center ${
                  ...
                  <p className={`text-[10px] font-semibold uppercase ${theme === "dark" ? "text-slate-400" : "text-slate-600"}`}>
                    Daily Target
                  </p>
                ...
                <div className={`p-4 rounded-lg border text-center ${
                  ...
                  <p className={`text-lg font-bold mt-2 ${theme === "dark" ? "text-purple-400" : "text-purple-600"}`}>
                ...
                <div className={`p-4 rounded-lg border text-center ${
                  ...
                  <p className={`text-lg font-bold mt-2 ${theme === "dark" ? "text-orange-400" : "text-orange-600"}`}>
            ...
            <div>
              <h3 className={`font-bold mb-3 ${theme === "dark" ? "text-white" : "text-gray-900"}`}>Target Markets</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {highProbabilityMarkets.map((market, idx) => (
                  ...
                  >
                    ...
                    <p className={`text-[10px] mt-1 ${theme === "dark" ? "text-slate-400" : "text-slate-600"}`}>
                      {market.description}
                    </p>
                    {useMartingale && (
          ...
          <TabsContent value="zones" className="space-y-4 mt-4">
            {zoneAnalysis && (
              <div className="space-y-3">
                {safeZones.length > 0 && (
                  <div>
                    <h3 className={`font-bold mb-3 text-sm ${theme === "dark" ? "text-green-400" : "text-green-600"}`}>
                ...
                {safeZones.length === 0 && (
                  <div className={`p-4 rounded-lg border flex items-start gap-2 ${
                    ...
                    <AlertCircle className={`w-4 h-4 mt-0.5 shrink-0 ${theme === "dark" ? "text-yellow-400" : "text-yellow-600"}`} />
                    <div>
                      <p className={`font-semibold text-sm ${theme === "dark" ? "text-yellow-400" : "text-yellow-600"}`}>
          ...
          <TabsContent value="stats" className="space-y-4 mt-4">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              ...
              <div className={`p-4 rounded-lg border text-center ${
                ...
                <p className={`text-[10px] font-semibold uppercase ${theme === "dark" ? "text-green-400" : "text-green-600"}`}>
                  Wins
                </p>
                <p className={`text-2xl font-bold mt-2 ${theme === "dark" ? "text-green-400" : "text-green-600"}`}>
                  {tradeStats.wins}
                </p>
              </div>
              ...
              <div className={`p-4 rounded-lg border text-center ${
                ...
                <p className={`text-[10px] font-semibold uppercase ${theme === "dark" ? "text-red-400" : "text-red-600"}`}>
                  Losses
                </p>
                <p className={`text-2xl font-bold mt-2 ${theme === "dark" ? "text-red-400" : "text-red-600"}`}>
                  {tradeStats.losses}
                </p>
              </div>

              <div className={`p-4 rounded-lg border text-center ${
                theme === "dark" ? "bg-blue-500/[0.08] border-blue-500/30" : "bg-blue-50 border-blue-200"
              }`}>
                <p className={`text-[10px] font-semibold uppercase ${theme === "dark" ? "text-blue-400" : "text-blue-600"}`}>
                  Win Rate
                </p>
                <p className={`text-2xl font-bold mt-2 ${theme === "dark" ? "text-blue-400" : "text-blue-600"}`}>
