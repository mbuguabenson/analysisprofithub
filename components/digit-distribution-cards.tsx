...
export function DigitDistributionCards({ ticks, theme = "dark" }: DigitDistributionCardsProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Summary Statistics */}
      <div className={`p-4 rounded-lg border grid grid-cols-3 gap-3 ${
        ...
        <div className="text-center">
          ...
          <p className={`text-lg font-bold mt-1 ${DIGIT_COLORS[Object.entries(distribution).sort(([,a], [,b]) => b - a)[0]?.[0] || 0].text}`}>
        ...
        <div className="text-center">
          ...
          <p className={`text-lg font-bold mt-1 ${DIGIT_COLORS[Object.entries(distribution).sort(([,a], [,b]) => a - b)[0]?.[0] || 0].text}`}>
