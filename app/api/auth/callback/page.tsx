...
export default function AuthCallbackPage() {
  ...
  useEffect(() => {
    ...
    // Provide legacy bridge: OAuth 2.0 Bearer tokens (ory_at...) fail V3 WS InputValidation.
    // Deriv sends legacy tokens alongside code down the URI when legacy app_id is passed.
    ...
    const handleLegacyRedirect = () => {
      ...
      if (firstToken) {
        console.log("[v0] 🏎️ Bridging legacy tokens for WebSocket V3 validation:", Object.keys(accounts))
        ...
        setError("No valid legacy bridge accounts found in redirect")
      }
    }
